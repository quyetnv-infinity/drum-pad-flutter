...
class SongCollectionAdapter extends TypeAdapter<SongCollection> {
  ...
  SongCollection read(BinaryReader reader) {
    ...
    return SongCollection(
      ...
      stepQuantity: fields[9] == null ? 0 : (fields[9] as num).toInt(),
      author: fields[1] == null ? 'Unknown' : fields[1] as String,
      name: fields[2] == null ? 'Unknown' : fields[2] as String,
      pathZipFile: fields[8] == null ? '' : fields[8] as String,
      difficulty:
...
class CategoryAdapter extends TypeAdapter<Category> {
  ...
  Category read(BinaryReader reader) {
    ...
    return Category(
      ...
      items: fields[3] == null
          ? const []
          : (fields[3] as List?)?.cast<CategoryItem>(),
    );
  }
...
class CategoryItemAdapter extends TypeAdapter<CategoryItem> {
  ...
  CategoryItem read(BinaryReader reader) {
    ...
    return CategoryItem(
      ...
      items: fields[3] == null
          ? const []
          : (fields[3] as List?)?.cast<SongCollection>(),
    );
  }
