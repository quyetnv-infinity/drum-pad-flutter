...
class BodyCampaignDetail extends StatefulWidget {
  final String difficulty;

  const BodyCampaignDetail({super.key, required this.difficulty});

  @override
  State<BodyCampaignDetail> createState() => _BodyState();
}

class _BodyState extends State<BodyCampaignDetail> {
  ...
  Widget build(BuildContext context) {
    return Center(child: _buildCampaignContent(),);
  }
