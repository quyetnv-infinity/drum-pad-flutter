...
class _ProfileScreenState extends State<ProfileScreen> with ScreenLogger<ProfileScreen>, ScreenTimeLogger<ProfileScreen> {
  @override
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      JudgementText.perfect('Perfect', underline: true, fontSize: 24, fontWeight: FontWeight.w400, italic: false),
                      JudgementText.good('Good', underline: true, fontSize: 24, fontWeight: FontWeight.w400, italic: false),
                      JudgementText.early('Early', underline: true, fontSize: 24, fontWeight: FontWeight.w400, italic: false),
                      JudgementText.late('Late', underline: true, fontSize: 24, fontWeight: FontWeight.w400, italic: false),
                      JudgementText.miss('Miss', underline: true, fontSize: 24, fontWeight: FontWeight.w400, italic: false),
                    ],
                  ),
                ),
                Container(
